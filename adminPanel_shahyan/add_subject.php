  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      // }
              ...
              <form action="process/subject_insertion.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label>Subject Name</label>
                    <input type="text" name="sname" placeholder="Subject Name" class="form-control">
                  </div>
                  <div class="form-group">
                    <label>Credit Hours</label>
                    <input type="text" name="crdhour" placeholder="Credit Hours"  class="form-control">
                  </div>
