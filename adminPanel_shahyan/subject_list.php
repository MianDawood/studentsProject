...
<?php
   ...
   if (isset($_GET['id']) && $_GET['id'] != "") {
     ...
     if ($block == 0) {
       $query = "update subject set status = 1 where Subject_ID = '$id'";
       $go=mysqli_query($connect,$query);
     }
     else{
      $query = "update subject set status = 0 where Subject_ID = '$id'";
      $go=mysqli_query($connect,$query);
     }
   }
   ...
   if (isset($_GET['table_search'])) {
     ...
     $query = "select * from subject where sname like '%$search%' order by Subject_ID desc";
     $go=mysqli_query($connect,$query);
   }
              ...
              <div class="card-header bg-info">
                ...
                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 170px;">
                    ...
                    <div class="input-group-append">
                      <a href = "process/DeleteAllSubject.php"
                  ...
                  <tbody class="">
                    <?php $a=1; while($rec=mysqli_fetch_array($go)) {?>
                      <tr>
                        ...
                        <td><?php echo $rec['Credit_Hours']; ?></td>
                       <!--  <td><?php echo $rec['Class_Name']; ?></td> -->
                        <!-- <td><?php echo $rec['City']; ?></td> -->
                        <td>
                           <?php if($rec['status'] == 0) { ?>
                            <a href="subject_list.php?id=<?php echo $rec['Subject_ID']; ?>&&status=<?php echo $rec['status']; ?>">
                          ...
                          <a href="edit_subject.php?id=<?php echo $rec['Subject_ID']; ?>"
                          ...
                          <a href="process/delete_subject.php?id=<?php echo $rec['Subject_ID'];?>"
                           onclick="return confirm('are you sure want to delete this record from your list?')" >
