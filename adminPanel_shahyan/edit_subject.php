  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      // }
              ...
              <form action="process/update_subject.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label>Subject Name</label>
                    <input type="text" name="sname" placeholder="First Name" value="<?php echo $edit['Subject_Name']; ?>" class="form-control">
                  </div>
                  <div class="form-group">
                    <label>Credit Hours</label>
                    <input type="text" name="crdhour" placeholder="Last Name" value="<?php echo $edit['Credit_Hours']; ?>" class="form-control">
                  </div>
                                      <!--  <div class="form-group">
...
<!-- 
                ...
                <div>
                  ...
                  <input type="hidden" name="hide" value="student">
                   <input type="hidden" name="update" value="<?php echo $edit['Subject_ID'] ?>">
