...
(1, 'Ali yar', 'afridi', 'aliyar@gmail.com', '0333898982', '', 'Male', 1),
(2, 'Atiq Sir', 'Malik', 'atiq@gmail.com', '0312787865', '', 'Male', 1);
...
INSERT INTO `teacher_subjects` (`ts_id`, `Teacher_ID`, `Subject_ID`, `date`, `status`) VALUES
(1, 1, 1, '2021-11-05 09:25:51', 1),
(2, 1, 3, '2021-11-05 09:26:19', 1),
(6, 2, 3, '2021-11-05 09:28:44', 1),
(7, 1, 2, '2021-11-05 09:43:51', 1),
(8, 2, 2, '2021-11-05 09:43:59', 1);
...
ALTER TABLE `teacher_subjects`
  ...
  ADD KEY `FK_teacher_subjects_1` (`Teacher_ID`),
  ADD KEY `FK_teacher_subjects_2` (`Subject_ID`);
...
--
ALTER TABLE `teacher_subjects`
  MODIFY `ts_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `teacher_subjects`
  ADD CONSTRAINT `FK_teacher_subjects_1` FOREIGN KEY (`Teacher_ID`) REFERENCES `teacher` (`Teacher_ID`),
  ADD CONSTRAINT `FK_teacher_subjects_2` FOREIGN KEY (`Subject_ID`) REFERENCES `subject` (`Subject_ID`);
