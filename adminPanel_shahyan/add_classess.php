  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row ">
          ...
          <button type='button' class='close' data-dismiss='alert'>&times;</button>".
                ...
                echo "<h6 class='alert alert-secondary'>Classes</h6>";
              }
      ...
      // }
              ...
              <form action="process/class_insertion.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label>Class Name</label>
                    <input type="text" name="className" placeholder="Enter Class" class="form-control">
                  </div>
                  <div class="form-group">
                    <label>Section</label>
